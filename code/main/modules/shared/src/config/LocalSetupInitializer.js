...
exports.LocalSetupInitializer = void 0;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
class LocalSetupInitializer {
    DEFAULT_DIRECTORY = '.cctop';
    /**
     ...
     */
    async createDirectoryStructure(configPath) {
        const directories = [
            '', // .cctop/
            'config', // config files
            'themes', // color themes
     ...
     */
    async createConfigurationFiles(configPath) {
     ...
     */
    async createGitIgnore(configPath) {
...
`;
     ...
     */
    generateSuccessMessage(configPath) {
...
Starting monitoring...`;
     ...
     */
    generateDryRunMessage(configPath) {
...
exports.LocalSetupInitializer = LocalSetupInitializer;
