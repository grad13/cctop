...
describe('ConfigLoader - Initialization', () => {
  ...
  describe('Initialization Flow', () => {
    it('should initialize configuration structure properly', async () => {
      ...
      // Verify directory structure created by loadConfiguration
      expect(fs.existsSync(configPath)).toBe(true);
      expect(fs.existsSync(path.join(configPath, 'config'))).toBe(true);

      // Verify view-config.json is auto-generated by ViewConfigManager
      expect(fs.existsSync(path.join(configPath, 'config', 'view-config.json'))).toBe(true);
    });
    ...
    it('should validate configuration after initialization', async () => {
      ...
      expect(config.shared).toHaveProperty('project');

      // Validate daemon config
      expect(config.daemon).toHaveProperty('daemon');
      expect(config.daemon.daemon).toHaveProperty('pidFile');
