...
class SelectionManager {
  constructor(keyInputManager, renderController) {
  ...
  /**
   * Update display with selection highlighting
   */
  updateDisplay() {
    if (this.displayRenderer && this.displayRenderer.updateSelection) {
      this.displayRenderer.updateSelection({
