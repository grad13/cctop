...
const InteractiveFeatures = require('./InteractiveFeatures');
...
async function runDemo() {
  ...
  try {
    ...
    for (const file of testFiles) {
      const fileId = await dbManager.ensureFile(file);
    ...
    const components = interactive.getComponents();
    ...
    const aggOutput = aggDisplay.render();
    ...
    const histOutput = histDisplay.render();
