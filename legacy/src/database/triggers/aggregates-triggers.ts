...
interface AggregatesTriggers {
  updateAggregatesOnEvent: string;
  updateAggregatesOnMeasurement: string;
  dropTriggers: string[];
}

const aggregatesTriggers: AggregatesTriggers = {
