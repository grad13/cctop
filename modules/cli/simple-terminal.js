...
/**
 * Simple Terminal UI Demo (using built dist files)
 */

const { BlessedTerminalUI } = require('./dist/ui/blessed-terminal-ui.js');
...
async function runTerminalDemo() {
  console.log('Starting Terminal UI Demo...');
  ...
  try {
    ...
    const ui = new BlessedTerminalUI(mockDb);
