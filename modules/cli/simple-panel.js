...
/**
 * Simple Panel UI Demo (using built dist files)
 */

const { BlessedPanelUI } = require('./dist/ui/blessed-panel-ui.js');
...
async function runPanelDemo() {
  console.log('Starting Panel UI Demo...');
