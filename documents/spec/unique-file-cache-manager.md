...
| Source | Runtime |
|--------|---------|
| modules/view/src/cache/UniqueFileCacheManager.ts | Node.js |

| Field | Value |
|-------|-------|
| Related | view-display-integration.md, ui-filter-integration.md |
| Test Type | Unit |
...
| File | Role |
|------|------|
| `modules/view/src/cache/UniqueFileCacheManager.ts` | Cache management |
| `modules/view/src/cache/index.ts` | Exports |
| `modules/view/src/database/FileEventReader.ts` | Incremental query |
| `modules/view/src/ui/UIDataManager.ts` | Integration |
