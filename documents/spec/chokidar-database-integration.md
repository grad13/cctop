...
| Source | Runtime |
|--------|---------|
| modules/daemon/src/events/FileEventHandler.ts, modules/daemon/src/events/MeasurementCalculator.ts, modules/daemon/src/events/MoveDetector.ts, modules/daemon/src/database/FileEventRecorder.ts | Node.js |

| Field | Value |
|-------|-------|
| Related | sqlite-database-foundation.md, file-lifecycle-tracking.md, background-activity-monitor.md |
