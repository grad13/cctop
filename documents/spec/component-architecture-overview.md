...
| Field | Value |
|-------|-------|
| Related | spec/module-dependency-diagram.md, spec/milestones-strategy.md, spec/stream-mode-architecture.md |
| Test Type | N/A |
...
**Implementation path**: `modules/daemon/src/`
...
**Implementation path**: `modules/view/src/`
...
**Implementation path**: `modules/shared/src/`
