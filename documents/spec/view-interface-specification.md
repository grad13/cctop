...
| Source | Runtime |
|--------|---------|
| modules/view/src/index.ts, modules/view/src/config/config-loader.ts | Node.js |

| Field | Value |
|-------|-------|
| Related | hierarchical-config-management.md, local-setup-initialization.md, background-activity-monitor.md |
| Test Type | Unit |
