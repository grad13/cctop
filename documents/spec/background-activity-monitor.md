...
| Source | Runtime |
|--------|---------|
| modules/daemon/src/index.ts, modules/daemon/src/system/PidManager.ts, modules/daemon/src/system/SignalHandler.ts, modules/daemon/src/logging/LogManager.ts | Node.js |

| Field | Value |
|-------|-------|
| Related | sqlite-database-foundation.md, file-lifecycle-tracking.md, chokidar-database-integration.md, hierarchical-config-management.md |
