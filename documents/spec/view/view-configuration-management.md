...
| Source | Runtime |
|--------|---------|
| view/src/config/ViewConfig.ts, view/src/config/ViewConfigManager.ts, view/src/config/config-loader.ts | Node.js |

| Field | Value |
|-------|-------|
| Related | shared/hierarchical-config-management.md, shared/local-setup-initialization.md |
| Test Type | Unit |
...
- `view/tests/functional/config/config-loader.test.ts`
- `view/tests/functional/config/config-loader-core.test.ts`
- `view/tests/functional/config/config-loader-initialization.test.ts`
