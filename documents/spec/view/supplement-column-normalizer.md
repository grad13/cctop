...
status: draft
source:
  - path: code/view/src/ui/components/EventTable/utils/columnNormalizer.ts
...
| Source | Runtime |
|--------|---------|
| `code/view/src/ui/components/EventTable/utils/columnNormalizer.ts` | TypeScript (Node.js ESM) |
