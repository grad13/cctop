...
status: draft
source:
  - path: code/view/src/ui/components/EventTable/formatters/ColumnFormatter.ts
...
| Source | Runtime |
|--------|---------|
| `code/view/src/ui/components/EventTable/formatters/ColumnFormatter.ts` | TypeScript (Node.js ESM) |
