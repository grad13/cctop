...
Deprecated: -
Format: spec-v2.1
Source: modules/daemon/src/index.ts, modules/view/src/index.ts, modules/shared/src/index.ts
---
...
| Source | Runtime |
|--------|---------|
| modules/daemon/src/index.ts | Node.js |
| modules/view/src/index.ts | Node.js |
| modules/shared/src/index.ts | Node.js |
...
[File Change]
    | (chokidar watch)
    v
[FUNC-002: Event Detection]      modules/daemon/src/events/FileEventHandler.ts
    | (normalize and classify)
    v
[FUNC-001: Lifecycle Tracking]   modules/daemon/src/database/FileEventRecorder.ts
    | (persist to database)
    v
[FUNC-000: SQLite Storage]       modules/daemon/src/database/SchemaManager.ts
    | (read-only query)
    v
[FUNC-202: CLI Display]          modules/view/src/ui/BlessedFramelessUI.ts
    | (render to screen)
    v
...
```
[FUNC-105: Initialization]       modules/shared/src/config/LocalSetupInitializer.ts
    | (create directory)
    v
[FUNC-101: Common Config]        modules/shared/src/config-manager.ts
...
**Source**: `modules/daemon/src/database/SchemaManager.ts`
...
**Source**: `modules/daemon/src/database/FileEventRecorder.ts`, `modules/daemon/src/events/FileEventHandler.ts`
...
**Source**: `modules/daemon/src/events/FileEventHandler.ts`
...
**Source**: `modules/daemon/src/system/PidManager.ts`, `modules/daemon/src/system/SignalHandler.ts`
...
**Source**: `modules/shared/src/config-manager.ts`, `modules/shared/src/config/SharedConfig.ts`
...
**Source**: `modules/view/src/index.ts`
...
**Source**: `modules/shared/src/config/LocalSetupInitializer.ts`
...
**Source**: `modules/view/src/ui/components/EventTable/utils/stringUtils.ts`
...
**Source**: `modules/view/src/ui/UIScreenManager.ts`
...
**Source**: `modules/view/src/ui/BlessedFramelessUI.ts`, `modules/view/src/ui/UIDataManager.ts`
