...
| Source | Runtime |
|--------|---------|
| modules/view/src/search/ | Node.js |
...
Key files:
- `modules/view/src/search/KeywordSearchManager.ts`
- `modules/view/src/search/MultiKeywordProcessor.ts`
- `modules/view/src/search/TextNormalizer.ts`
