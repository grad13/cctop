...
| Field | Value |
|-------|-------|
| Related | modules/daemon/src/database/FileEventRecorder.ts, modules/daemon/src/database/EventOperations.ts, modules/daemon/src/database/AggregateOperations.ts, modules/daemon/src/database/MeasurementOperations.ts |
| Test Type | Unit |
