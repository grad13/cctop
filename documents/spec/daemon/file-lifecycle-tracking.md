...
| Source | Runtime |
|--------|---------|
| daemon/src/events/FileEventHandler.ts, daemon/src/events/MoveDetector.ts | Node.js |

| Field | Value |
|-------|-------|
| Related | daemon/sqlite-database-foundation.md, daemon/chokidar-database-integration.md, daemon/background-activity-monitor.md |
