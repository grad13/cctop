...
| Source | Runtime |
|--------|---------|
| daemon/src/config/DaemonConfig.ts, shared/src/config/DaemonConfig.ts | Node.js |

| Field | Value |
|-------|-------|
| Related | shared/hierarchical-config-management.md, daemon/background-activity-monitor.md, daemon/file-lifecycle-tracking.md, daemon/chokidar-database-integration.md |
| Test Type | Unit |
...
- `daemon/tests/unit/production-config.test.ts`
