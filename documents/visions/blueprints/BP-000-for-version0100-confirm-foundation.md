...
- package.json更新（依存関係追加）
  - postinstallスクリプトの設定（[INST001](../specifications/installation/inst001-post-install-setup.md)参照）
- ディレクトリ構造作成
- bin/cctop実行ファイル作成
- 設定ファイルの初期化（[CONFIG001](../specifications/config/config001-management.md)参照）
