...
- **設定構造**: [FUNC-010: ローカル・グローバル設定管理](./FUNC-010-local-global-storage-management.md)
- **config.json**: [FUNC-011: 階層的設定管理](./FUNC-011-hierarchical-config-management.md)
